...
public class LabTestBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edname = findViewById(R.id.edtTextLabTestFullName);
        edaddress = findViewById(R.id.edtTextLabTestAddress);
        edcontact = findViewById(R.id.edtTextLabTestMobileNumber);
        edpincode = findViewById(R.id.edtTextLabTestPinCode);
        btnBook = findViewById(R.id.btnBookLabTest);
